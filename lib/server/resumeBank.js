...
- Foreground whichever real skills, methods, and results in the entry are most relevant to this JD. The same real experience should read differently for a data/analytics JD (lead with the technical method, model, or tool) versus a marketing/growth JD (lead with the growth, channel, or strategy angle) — you are choosing which true facts to foreground and how to phrase them, never changing what happened.
...
- Rewriting means rephrasing the user's REAL bullets — never adding a fact, metric, or achievement that isn't a reworded version of one of the original bullets for that entry. You may drop a bullet that isn't relevant, but never invent a new one.
